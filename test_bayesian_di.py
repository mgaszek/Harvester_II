...
def main():
    ...
    try:
        ...
        if bsm:
            ...
            print(f"  Panic scenario: {result['conviction_level']} ({result['confidence']:.2f})")
            ...
            print(f"  Calm scenario: {calm_result['conviction_level']} (should_trade: {calm_result['should_trade']})")
