...
def test_bias_detection():
    ...
    mock_result = {
        'trades': [
            {'entry_time': '2020-01-01', 'exit_time': '2020-01-02', 'pnl_percentage': 0.02},
            {'entry_time': '2020-01-03', 'exit_time': '2020-01-04', 'pnl_percentage': -0.01},
        ],
        'capital': {
            'total_return': 0.15,
            'sharpe_ratio': 1.8,
...
def test_walk_forward_structure():
    ...
    try:
        result = engine.run_walk_forward_validation('2020-01-01', '2021-01-01',
                                                  train_window_months=6, test_window_months=1)
