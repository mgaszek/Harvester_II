...
@pytest.fixture
def mock_portfolio_manager(sample_config, sample_risk_manager, mock_data_manager, sample_signal_calculator):
...
@pytest.fixture
def sample_components(sample_config, mock_data_manager, sample_signal_calculator, sample_risk_manager, mock_portfolio_manager):
    """Create a complete set of components for integration testing."""
    from engine import TradingEngine

    trading_engine = TradingEngine(sample_config, mock_data_manager, sample_signal_calculator, sample_risk_manager, mock_portfolio_manager)
